...
echo "Set len position (piezo) MIN A1, A5"
$CMD 0x0B 0x00 0x01 0x40 0x00 0x22 0x00 0x00 0x00 0x00 0x00 0x00
echo "Set len position (piezo) MIN A1, B2"
$CMD 0x0B 0x00 0x02 0x40 0x00 0x82 0x00 0x00 0x00 0x00 0x00 0x00
