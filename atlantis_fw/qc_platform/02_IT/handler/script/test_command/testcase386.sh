...
echo "Get len position (piezo) A1, A5"
$CMD 0x07 0x00 0x01 0x40 0x00 0x22 0x00 0x00
$CMD 0x04 0x40 0x00
$CMD cat
echo "Get len position (piezo) A1, B2"
$CMD 0x07 0x00 0x02 0x40 0x00 0x82 0x00 0x00
$CMD 0x04 0x40 0x00
$CMD cat
