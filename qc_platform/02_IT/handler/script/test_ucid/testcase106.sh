...
echo "Set focus len"
$CMD 0x0B 0x00 0x06 0x3A 0x00 0x02 0x00 0x00 0x03 0x00 0x32 0x00
echo "Stream on B4"
$CMD 0x0A 0x00 0x07 0x02 0x00 0x02 0x00 0x00 0x11 0x00 0x00
echo "Stream off B4"
$CMD 0x0A 0x00 0x08 0x02 0x00 0x02 0x00 0x00 0x10 0x00 0x00
echo "Close camera"
$CMD 0x08 0x00 0x09 0x00 0x00 0x02 0x00 0x00 0x00
