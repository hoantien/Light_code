...
echo "Get exposure time A1, A5"
$CMD 0x09 0x00 0x02 0x32 0x00 0x22 0x00 0x00 0x03 0x00
$CMD 0x10 0x32 0x00
$CMD cat
echo "Get exposure time A1, B2"
$CMD 0x09 0x00 0x03 0x32 0x00 0x82 0x00 0x00 0x03 0x00
$CMD 0x10 0x32 0x00
$CMD cat
