...
echo "Get sensitivity A1, A5"
$CMD 0x09 0x00 0x02 0x30 0x00 0x22 0x00 0x00 0x03 0x00
$CMD 0x08 0x30 0x00
$CMD cat
echo "Get sensitivity A1, B2"
$CMD 0x09 0x00 0x03 0x30 0x00 0x82 0x00 0x00 0x03 0x00
$CMD 0x08 0x30 0x00
$CMD cat
