...
echo "Read  stream status of A1, A5"
$CMD 0x10 0x00 0x01 0x02 0x00 0x22 0x00 0x00
$CMD 0x06 0x02 0x00
$CMD cat
echo "Read  stream status of A1, B2"
$CMD 0x10 0x00 0x02 0x02 0x00 0x82 0x00 0x00
$CMD 0x06 0x02 0x00
$CMD cat
