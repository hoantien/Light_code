...
echo "Set  fps MAX A1, A5"
$CMD 0x0D 0x00 0x02 0x50 0x00 0x22 0x00 0x00 0x03 0x00 0xFF 0xFF 0xFF 0xFF
echo "Set  fps MAX A1, B2"
$CMD 0x0D 0x00 0x03 0x50 0x00 0x82 0x00 0x00 0x03 0x00 0xFF 0xFF 0xFF 0xFF
