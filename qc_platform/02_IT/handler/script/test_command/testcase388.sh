...
echo "Set mirror position MAX A1, A5"
$CMD 0x0B 0x00 0x01 0x44 0x00 0x22 0x00 0x00 0xFF 0xFF 0xFF 0xFF
echo "Set mirror position MAX A1, B2"
$CMD 0x0B 0x00 0x02 0x44 0x00 0x82 0x00 0x00 0xFF 0xFF 0xFF 0xFF
