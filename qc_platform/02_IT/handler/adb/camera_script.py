...
target = " > /sys/class/i2c-adapter/i2c-11/11-0010/i2c_w"
ft4222 = "ft4222"
...
if args.camera:
	...
	if args.open:
		...
		print ""
		if args.ucid:
			ucid_string = "adb shell 'echo 4 0x0000 0x00 0x10 " + ucid_to_hex(args.ucid) + target +  "'"
	...
	if args.stream:
		...
		camera_string = "adb shell \"echo " + str(byte_count) + " 0x0000 0x02 0x00 " + m_bitmask \
						+ " " + stream_string + "> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_w\""
		#print camera_string
	...
	if args.read:
		...
		for camera in args.camera:
			if camera == 'g':
				...
				byte_count +=4
		read_string = "adb shell \"echo " + str(byte_count) + " 0x0048 " \
		            + "> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
		#print read_string
		execute(read_string)
		#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
		execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\n\"")
		print ""
	else:
		for camera in args.camera:
		...
		if args.ucid:
			...
			focus_string = "adb shell \"echo " + str(byte_count + 2) \
			             + " 0x0000 0x48 0x00 " + m_bitmask + " "    \
			             + ucid + " " + fstring + target + "\""
		else:
			focus_string = "adb shell \"echo " + str(byte_count)  \
			             + " 0x0000 0x48 0x00 " + m_bitmask + " " \
			             + fstring + target + "\""
		#print focus_string
		execute(focus_string)
			...
			if args.ucid:
				...
				for camera in args.camera:
					if camera == 'g':
						...
						byte_count +=8
				read_string = "adb shell \"echo " + str(byte_count) + " 0x0032 "+"> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				#print read_string
				execute(read_string)
				#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\n\"")
			...
			if args.ucid:
				...
				for camera in args.camera:
					if camera == 'g':
						...
						byte_count +=4
				read_string = "adb shell \"echo " + str(byte_count) + " 0x0030 "+"> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				#print read_string
				execute(read_string)
				#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\n\"")
			...
			if args.ucid:
				...
				for camera in args.camera:
					if camera == 'g':
						...
						byte_count +=2
				read_string = "adb shell \"echo " + str(byte_count) + " 0x0050 "+"> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				#print read_string
				execute(read_string)
				#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\n\"")
			...
			if args.ucid:
				...
				for camera in args.camera:
					if camera == 'g':
						...
						byte_count +=8
				read_string = "adb shell \"echo " + str(byte_count) + " 0x002c "+"> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				#print read_string
				execute(read_string)
				#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
				execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\n\"")
...
if args.read_hall_sensor_value:
	...
	if args.lens:
		...
		read_string = "adb shell \"echo " + str(byte_count) + " 0x0040 " + "> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
		#print read_string
		execute(read_string)
		#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
		execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br \n\"")
	if args.mirror:
		...
		output_string = "adb shell \"echo 5 0x0000 0x44 0x00 " + m_bitmask + target +  "\""
		#print output_string
		execute(output_string)
		read_string = "adb shell \"echo " + str(byte_count) + " 0x0044 "+"> /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
		#print read_string
		execute(read_string)
		#print "adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br\""
		execute("adb shell \"cat /sys/class/i2c-adapter/i2c-11/11-0010/i2c_br \n\"")
